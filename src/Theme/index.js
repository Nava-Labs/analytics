...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#14B8A6' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#86EFAC' : '#14B8A6',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#14B8A6',

  // secondary colors
  secondary1: darkMode ? '#86EFAC' : '#14B8A6',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #14B8A630 0%, #fff 0%)`
})
