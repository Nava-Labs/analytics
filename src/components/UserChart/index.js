...
const UserChart = ({ account }) => {
  ...
  console.log('chart user data ', chartData)
  ...
  return (
    <ChartWrapper>
      {below600 ? (
        <RowBetween mb={40}>
          <div />
          <DropdownSelect options={timeframeOptions} active={timeWindow} setActive={setTimeWindow} color={'#14B8A6'} />
        </RowBetween>
      ) : (
        <RowBetween mb={40}>
          <AutoRow gap='10px'>
