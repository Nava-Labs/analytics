      ...
      <BlockedWrapper>
        <BlockedMessageWrapper>
          <AutoColumn gap='1rem' justify='center'>
            ...
            <Link external={true} href={'https://explorer.mantle.xyz/address/' + address}>{`More about ${shortenAddress(
              address
            )}`}</Link>
          </AutoColumn>
        </BlockedMessageWrapper>
          ...
          <DashboardWrapper style={{ marginTop: below1080 ? '0' : '1rem' }}>
            ...
            <RowBetween style={{ marginTop: '3rem' }}>
              ...
              <AutoRow gap='4px' style={{ width: 'fit-content' }}>
                ...
                />
                <QuestionHelper text='USD amounts may be inaccurate in low liquidity pairs or pairs without MNT or stablecoins.' />
              </AutoRow>
            </RowBetween>
            <Panel
              rounded
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={'https://explorer.mantle.xyz/address/' + address}>
