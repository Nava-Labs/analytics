...
export function getSwapLink (token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://app.esper.finance/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://app.esper.finance/#/swap?inputCurrency=${
...
export function getMiningPoolLink (token0Address) {
  return `https://app.esper.finance/#/uni/MNT/${token0Address}`
}

export function getUniswapAppLink (linkVariable) {
  let baseUniswapUrl = 'https://app.esper.finance/#/uni'
  if (!linkVariable) {
...
export const urls = {
  showTransaction: tx => `https://explorer.mantle.xyz/tx/${tx}/`,
  showAddress: address => `https://www.etherscan.io/address/${address}/`,
  showToken: address => `https://www.etherscan.io/token/${address}/`,
  showBlock: block => `https://explorer.mantle.xyz/block/${block}/`
}
